...
cutFiles = ["selections_slab_study_beamon_data.txt", "selections_slab_study_beamoff_data.txt"]
for cm in chargeMassCombinations:
    cutFiles.append("selections_slab_study_sim_m{0}q{1}.txt".format(cm[0], cm[1]))
